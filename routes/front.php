...
Route::group([
    ...
    Route::group(['namespace' => 'Front',], function () {
        ...
        Route::group(['prefix' => 'cart'], function () {
            ...
            Route::post('/cart/add/{slug?}', 'CartController@store')->name('site.cart.add');
            Route::post('/update/{slug}', 'CartController@update')->name('site.cart.update');
            Route::post('/update-all', 'CartController@updateAll')->name('site.cart.update-all');
        });
    });


    Route::group(['namespace' => 'Front', 'middleware' => ['auth', 'VerifiedUser']], function () {
